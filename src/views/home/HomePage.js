				...
				<div className="flex justify-start sm:justify-between flex-wrap">
					<div>
						...
						<ol className="relative border-l border-gray-200">
							...
							<li className="mb-10 ml-6">
								<span className="absolute flex items-center justify-center w-6 h-6 bg-blue-200 rounded-full -left-3 ring-8 ring-white">
									<img src={ IMAGES_PATH('./medals/Medalla_Arcoiris.png') } alt="medalla arcoíris" className="w-4 h-4 text-blue-600" />
								</span>
							...
							<li className="mb-10 ml-6">
								<span className="absolute flex items-center justify-center w-6 h-6 bg-blue-200 rounded-full -left-3 ring-8 ring-white">
									<img src={ IMAGES_PATH('./medals/Medalla_Volcan.png') } alt="medalla Volcán" className="w-4 h-4 text-blue-600" />
								</span>
					...
					<div>
						...
						<ol className="relative border-l border-gray-200">
							<li className="mb-10 ml-6">
								<span className="absolute flex items-center justify-center w-6 h-6 bg-blue-200 rounded-full -left-3 ring-8 ring-white">
									<img src={ IMAGES_PATH('./medals/Medalla_Cefiro.png') } alt="medalla céfiro" className="w-4 h-4 text-blue-600" />
								</span>
					...
					<div>
						...
						<ol className="relative border-l border-gray-200">
							...
							<li className="mb-10 ml-6">
								<span className="absolute flex items-center justify-center w-6 h-6 bg-blue-200 rounded-full -left-3 ring-8 ring-white">
									<img src={ IMAGES_PATH('./medals/Medalla_Puño.png') } alt="medalla puño" className="w-4 h-4 text-blue-600" />
								</span>
